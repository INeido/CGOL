...
def main():
    ...
    parser.add_argument(
        ...
        type=bool,
        required=False,
        help="Boolean indicating whether the space is toroidal or not.",
    )
    parser.add_argument(
        "--save-file",
        "-f",
    ...
    parser.add_argument(
        ...
        type=bool,
        required=False,
        help="Boolean determining if a previous save should be loaded.",
    )
    args = parser.parse_args()

    # Create new Game
    game = Game(args.tickrate, args.save_file, args.load)

    # Let Game create the World
    game.create_world(args.size_x, args.size_y, args.seed, args.toroidal)
